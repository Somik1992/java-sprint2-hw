...
public class MonthlyReport {
    ...
    public static void readMounthlyFile() {
        ...
        for (String name : names) {
            ...
            System.out.println("ћес€чный отчет за " + name.split("/")[1].substring(6, 8) + " считан");
    ...
    public static void printMountlyReport() {
        if (CustomFileReader.checkReports()) {
            ...
            for (String month : TotalReport.keySet()) {
                ...
                System.out.println("Ѕольше всего выручки принес " + "'" + maxRevenueItem + "'" + " с выручкой = " + maxRevenue);
                System.out.println("Ѕольше всего убытков принес " + "'" + maxExpensesItem + "'" + " с убытком = " + maxExpenses);
            }
        }
    }
}
